...
angular.module('starter.controllers', ['firebase','ionic', 'ngCordova'])
  ...
  .controller('AccountCtrl', function($scope, $interval, sFirebase) {
    ...
    $scope.disconnect = function() { firebase.auth().signOut() }
    var configWeight = {
  ...
  .controller('LoginCtrl', function($scope, $ionicLoading, sFirebase, $location) {
    $scope.submit = function(username, password) {
      // alert($scope.password + " : " + $scope.email)
      ...
      sFirebase.login($scope.email, $scope.password, sFirebase)
      $ionicLoading.hide()
    }
  })

  .controller('RegisterCtrl', function($scope, $ionicLoading, sFirebase) {
    $scope.submit = function() {
      // alert($scope.passwordP + " : " + $scope.email)
